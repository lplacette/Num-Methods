...
class Matrix:
    ...
    def Dot_Product(self,other):
        """returns dot product of two given matrices"""
        return self.Transpose()*other
    
#    def Cross_Product(self,other):
#        """returns cross product of given vectors"""
#        if self.m!=other.m or self.n!=1 or other.n!=1:
#            raise Exception("invalid dimensions for cross product; must have one column and equivalent rows")
#        else:
...
K=Matrix(3,3)
K.rows=[[4,12,-16],[12,37,-43],[-16,-43,98]]
L,D,LT=K.LDLT_Decomposition()
